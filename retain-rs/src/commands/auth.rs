...
pub async fn handle(_args: &ArgMatches, ipc: &mut IPCConnection) -> Result<(), ()> {
    ...
    eprintln!("You will need an app key. This consist of the applicationKeyId and the applicationKey");
    eprintln!(r#"SECURITY NOTICE - PLEASE READ
...
"#);
    ...
    let encoded_key = base64::encode(key_string);
